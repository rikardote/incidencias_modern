...
Route::view('/', 'welcome_choice')->name('welcome');
...
Route::middleware('auth')->group(function () {
    ...
    // Reportes
    Route::get('/reportes/rh5', \App\Livewire\Reports\Rh5Report::class)->name('reports.rh5');
    ...
    // Importación de empleados (desactivado por ahora)
...
// ─── FIREBASE SERVICE WORKER (DINÁMICO) ─────────────────────────
Route::get('/firebase-messaging-sw.js', function () {
    $content = "importScripts('https://www.gstatic.com/firebasejs/8.10.1/firebase-app.js');
