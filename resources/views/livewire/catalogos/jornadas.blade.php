            ...
            <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg overflow-hidden">
                ...
                <div class="p-6">
                    <div wire:loading.class="opacity-50" wire:target="search"
                        ...
                        @forelse($jornadas as $item)
                        <div wire:key="jornada-{{ $item->id }}"
                            ...
                            <div class="flex flex-col xl:flex-row xl:items-center justify-between gap-4 px-4 py-3">
                                        ...
                                        <div class="flex items-center gap-2 flex-wrap mb-1">
                                            <span
                                                ...
                                                <svg class="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 0 1 2.25-2.25h13.5A2.25 2.25 0 0 1 21 7.5v11.25m-18 0A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75m-18 0v-7.5A2.25 2.25 0 0 1 5.25 9h13.5A2.25 2.25 0 0 1 21 11.25v7.5" />
                                                </svg>
                                            </span>
                                            <span
                                ...
                                <div class="shrink-0 flex flex-wrap items-center justify-around sm:justify-end gap-1 w-full xl:w-auto border-t xl:border-t-0 border-gray-100 dark:border-gray-700 pt-3 xl:pt-0">
                                    ...
                                    <button onclick="confirmDeleteJornada('{{ $item->id }}')"
                        ...
                        <div class="py-16 text-center">
                            ...
                            <p class="text-sm text-gray-400 italic">No se encontraron jornadas registradas.</p>
                        </div>
                        @endforelse
                    </div>
        ...
        <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div
                ...
                <div
                    ...
                    <div class="relative z-10 flex items-center gap-3">
                        ...
                        <h3 class="text-lg font-black uppercase tracking-widest">
                            {{ $jornadaId ? 'Editar Jornada' : 'Nueva Jornada' }}
                        </h3>
                    </div>
                ...
                <form wire:submit.prevent="save" class="flex flex-col h-full overflow-hidden">
                    <div class="px-8 py-6">
                        <div>
                            <label for="jornada" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Nombre de la Jornada</label>
                            <input type="text" wire:model="jornada" id="jornada" placeholder="Ej. Lunes a Viernes"
                            ...
                            @error('jornada') <span class="text-red-500 text-xs mt-1 block font-bold">{{ $message }}</span> @enderror
                        </div>
                    </div>
