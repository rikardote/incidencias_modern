                                    ...
                                    <div class="flex-1 min-w-0">
                                        <div class="flex items-center gap-3 flex-wrap">
                                            <div class="flex flex-col">
                                                <span class="text-[10px] font-bold text-gray-400 uppercase tracking-tighter">Año</span>
                                                <span class="text-sm font-black text-[#9b2247] dark:text-[#e6d194]">{{ $p->year }}</span>
                                            </div>
                                            <div class="w-px h-6 bg-gray-100 dark:bg-gray-700"></div>
                                            <div class="flex flex-col">
                                                <span class="text-[10px] font-bold text-gray-400 uppercase tracking-tighter">Periodo</span>
                                                <span class="text-sm font-black text-gray-700 dark:text-gray-300">{{ $p->periodo }}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
