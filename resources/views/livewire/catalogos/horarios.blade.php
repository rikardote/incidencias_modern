                ...
                <div class="p-6">
                    <div wire:loading.class="opacity-50" wire:target="search"
                        ...
                        <div wire:key="horario-{{ $item->id }}"
                            ...
                            <div class="flex flex-col xl:flex-row xl:items-center justify-between gap-4 px-4 py-3">
                                ...
                                <div class="shrink-0 flex flex-wrap items-center justify-around sm:justify-end gap-1 w-full xl:w-auto border-t xl:border-t-0 border-gray-100 dark:border-gray-700 pt-3 xl:pt-0">
                                    ...
                                    <button onclick="confirmDeleteHorario('{{ $item->id }}')"
                        ...
                        <div class="py-16 text-center">
                            ...
                            <p class="text-sm text-gray-400 italic">No se encontraron horarios registrados.</p>
                        </div>
                        @endforelse
                    </div>
        ...
        <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div
                ...
                <form wire:submit.prevent="save" class="flex flex-col h-full overflow-hidden">
                    <div class="px-8 py-6">
                        <div>
                            <label for="horario" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Descripción del Horario</label>
                            <input type="text" wire:model="horario" id="horario" placeholder="Ej. 08:00 - 15:30"
                            ...
                            @error('horario') <span class="text-red-500 text-xs mt-1 block font-bold">{{ $message }}</span> @enderror
                        </div>
                    </div>
