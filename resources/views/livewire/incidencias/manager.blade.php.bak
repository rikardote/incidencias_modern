                        ...
                        <div class="p-4">
                            ...
                            <form wire:submit.prevent="store" class="space-y-4">
                                ...
                                <div
                                    ...
                                    {{-- Campos de Omisión de Entrada/Salida (código 901) --}}
                                    @if($isOtorgado)
                                    <div
                                        class="p-5 bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm relative overflow-hidden group">
                                        <div
                                            class="absolute top-0 left-0 w-1 h-full bg-[#13322B] dark:bg-[#e6d194]">
                                        </div>
                                        ...
                                        <div class="flex items-start gap-4">
                                            ...
                                            <div class="flex-1 min-w-0">
                                                <h4
                                                    class="text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] mb-4">
                                                    Detalles de otorgado</h4>

                                                <div>
                                                    <label
                                                        class="block text-[9px] font-black text-gray-400 uppercase tracking-widest mb-1.5 ml-1">Especifique el Motivo</label>
                                                    <input type="text" wire:model="otorgado"
                                                        placeholder="Describa el motivo por el cual es otorgado..."
                                                        class="block w-full h-9 px-3 bg-white dark:bg-gray-950 border border-gray-200 dark:border-gray-700 rounded-lg text-xs font-bold text-gray-700 dark:text-gray-300 focus:ring-2 focus:ring-[#13322B]/30 outline-none transition-all">
                                                    @error('otorgado') <span
                                                        class="text-red-500 text-[10px] font-bold mt-1 ml-1 block">{{
                                                        $message }}</span> @enderror
                                                            ...
                                                            <div
                                                                ...
                                                                <div @click.stop="select('{{ $medico->id }}')"
                                                                    ...
                                                                    <div class="flex items-center">
                                                                        <span>{{ $medico->num_empleado }} - {{ $medico->fullname }}</span>
                                                                    </div>
                                                                </div>
                                                                @endforeach
                                                                @if(count($medicos) === 0)
                    ...
                    <div
                        ...
                        <div class="p-6 text-center border-b border-gray-200 dark:border-gray-700 relative">
                            ...
                            <div class="space-y-2 mt-2">
                                {{-- Línea 1: NUMERO DE EMPLEADO - NOMBRE --}}
                                    <h2 class="text-xl text-[#333333] dark:text-gray-100 leading-none flex items-center justify-center gap-4">
                                        <span class="font-bold border-r border-gray-300 dark:border-gray-600 pr-3 text-[#9b2247] dark:text-[#e6d194]">
                                            {{ $employee->num_empleado }}
                                        </span>
                                        <span class="font-bold">{{ strtoupper($employee->fullname) }}</span>
                                    </h2>
                                ...
                                <tbody class="divide-y divide-gray-50 dark:divide-gray-700/50">
                                    ...
                                    <tr>
                                        <td colspan="6" class="px-4 py-20 text-center">
                                            ...
                                            <span
                                                class="text-[11px] font-black text-gray-400 uppercase tracking-widest">Sin
                        ...
                        <div
                            ...
                            <div
                                ...
                                <span
                                    class="text-[10px] font-black text-gray-400 uppercase tracking-widest block px-4">Sin
            ...
            <div class="p-8">
                ...
                <div class="mt-6">
                    <div x-show="query.length < 2" class="text-center py-10">
                        ...
                        <p class="text-xs text-gray-400 font-bold uppercase tracking-widest">Ingrese al menos 2
                            caracteres
                        </p>
                    </div>

                    <div x-show="query.length >= 2 && results.length === 0 && !loading" class="text-center py-10">
                        <p class="text-xs text-oro font-black uppercase tracking-widest">No se encontraron resultados
                        </p>
                    </div>

                    <div x-show="results.length > 0"
                        class="space-y-2 max-h-[45vh] overflow-y-auto custom-scrollbar pr-2">
