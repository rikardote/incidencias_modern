        ...
        <div class="w-full md:w-1/2">
            <div class="relative">
                <input type="text" wire:model.live.debounce.300ms="search" 
                    ...
                    class="w-full pl-10 pr-4 py-2 border border-gray-300 dark:border-gray-600 rounded bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 focus:ring-[#13322B] focus:border-[#13322B] text-sm shadow-sm transition"
                    autocomplete="off">
