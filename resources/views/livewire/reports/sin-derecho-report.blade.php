...
<div>
    {{-- Loading Overlay --}}
    <div wire:loading wire:target="generate, year, month, departmentId"
        ...
        <div
            ...
            <div class="text-center">
                ...
                <p class="text-[10px] text-gray-500 dark:text-gray-400 font-bold uppercase mt-1 italic">Esto puede tomar
                    unos segundos...</p>
            </div>
        </div>
    </div>
                    ...
                    <div class="flex items-end gap-3 mb-6 w-full">
                        ...
                        <div class="w-auto shrink-0">
                            <button wire:click="generate" wire:loading.attr="disabled"
                                class="bg-[#13322B] hover:bg-[#0a1f1a] text-white px-6 py-1.5 rounded text-sm font-bold uppercase tracking-wider transition whitespace-nowrap disabled:opacity-50 disabled:cursor-wait flex items-center gap-2">
                        ...
                        <div class="overflow-x-auto rounded-lg border border-gray-200 dark:border-gray-700">
                            <table class="w-full text-sm text-left">
                                <thead
                                    ...
                                    <tr>
                                        <th class="px-4 py-3 font-semibold text-gray-600 dark:text-gray-300">No. Emp
                                        </th>
                                    ...
                                    <tr
                                        ...
                                        <td class="px-4 py-3 text-center">
                                            <button wire:click="showDetails({{ $emp->id }})"
                                                class="text-oro hover:text-[#9b2247] transition-colors"
                                                title="Ver Motivo">
                ...
                <div
                    ...
                    <div class="px-8 py-8 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100">
                        <div class="mb-6 flex flex-col">
                            <p class="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1">Empleado
                                Evaluado
                            </p>
                            <h4
                                class="font-bold text-[#13322B] dark:text-[#e6d194] text-2xl uppercase tracking-tighter">
                                {{
                                ...
                                <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                                    ...
                                    <tr class="hover:bg-gray-50/80 dark:hover:bg-gray-800/50 transition-colors">
                                        ...
                                        <td class="px-5 py-2 text-xs text-gray-500 dark:text-gray-400 leading-snug">
                                            ...
                                            <span class="italic text-[10px] leading-tight">{{ $inc['diagnostico']
                                                }}</span>
                                            @endif
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td colspan="5"
                                            class="py-16 text-center text-sm text-gray-400 italic font-medium">
