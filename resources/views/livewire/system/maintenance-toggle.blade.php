<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
    ...
    <div
        class="p-6 bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 flex flex-col justify-center">
        <h5 class="text-xs font-black text-gray-400 dark:text-gray-500 mb-4 nothing-font uppercase tracking-[0.3em]">
            Style Widget</h5>
    ...
    {{-- Toggle de Caritas (Faces) --}}
    <div x-data="{ localShow: $store.island.showFaces }"
        class="p-6 bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 flex flex-col justify-center">
        <div class="flex items-center justify-between">
            <div>
                <h5
                    class="text-xs font-black text-gray-400 dark:text-gray-500 mb-1 nothing-font uppercase tracking-[0.3em]">
                    GESTOS ASCII (CARITAS)</h5>
                <p class="text-[10px] text-gray-500 uppercase font-bold tracking-wider">
                    Mostrar rostros antes del mensaje
                </p>
            </div>
            ...
            <button @click="localShow = !localShow; $store.island.setFaces(localShow)"
                ...
                :class="localShow ? 'bg-oro' : 'bg-gray-200 dark:bg-gray-700'">
                <span class="sr-only">Toggle faces</span>
                <span aria-hidden="true"
                    ...
                    :class="localShow ? 'translate-x-5' : 'translate-x-0'"></span>
            </button>
        </div>
    </div>
</div>