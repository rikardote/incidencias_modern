<section>
    ...
    <div class="mt-6 p-6 bg-gray-50 dark:bg-gray-900/50 rounded-xl border border-gray-200 dark:border-gray-700" x-data="{ 
        ...
        <div class="flex items-center justify-between mb-6 border-b border-gray-200 dark:border-gray-700 pb-4">
            <div>
                ...
                <p class="text-[10px] text-gray-400 font-bold uppercase tracking-wider mt-0.5 italic">Cambios aplicados
                    solo a tu navegador</p>
            </div>

            <div
                class="flex items-center gap-3 bg-white dark:bg-gray-800 px-3 py-1.5 rounded-lg border dark:border-gray-700 shadow-sm">
                <span class="text-[10px] font-black text-gray-500 uppercase tracking-widest nothing-font">Mostrar
                    Caritas</span>
        ...
        <div class="space-y-4">
            <h6
                class="text-[9px] font-black text-[#9b2247] dark:text-[#e6d194] uppercase tracking-[0.2em] nothing-font">
                Selector de Estilo</h6>
            ...
            <p
                class="text-[10px] text-gray-500 dark:text-gray-400 italic mt-4 bg-white/50 dark:bg-black/20 p-2 rounded border border-dashed border-gray-200 dark:border-gray-700">
