...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased text-gray-800 dark:text-gray-200">
        <div class="min-h-screen flex items-center justify-center bg-gray-100 dark:bg-gray-950 relative overflow-hidden">
            ...
            <div class="w-full max-w-5xl flex flex-col md:flex-row bg-white/10 dark:bg-white/5 backdrop-blur-md shadow-[0_8px_32px_0_rgba(0,0,0,0.37)] border border-white/20 rounded-2xl overflow-hidden min-h-0 md:min-h-[600px] z-10 mx-4 my-8 md:my-0">
                
                <!-- Left Side: Branding -->
                <div class="w-full md:w-1/2 p-8 sm:p-12 flex flex-col justify-between relative overflow-hidden text-white bg-gradient-to-br from-[#13322B]/90 to-[#0a1f1a]/90 backdrop-blur-sm h-72 md:h-auto">
                    ...
                    <div class="relative z-20">
                        ...
                        <div class="mt-8 md:mt-12">
                            <h2 class="text-3xl sm:text-5xl font-extrabold leading-tight tracking-tight drop-shadow-md">Gestión de<br><span class="text-oro">Incidencias</span></h2>
                            <p class="hidden md:block mt-4 text-gray-200 text-lg font-light leading-relaxed max-w-sm drop-shadow-sm">Plataforma administrativa para el control de asistencia de la Representación Estatal Baja California.</p>
                        </div>
                    </div>

                    <div class="relative z-20 mt-6 md:mt-12 pb-2">
                        <div class="flex items-center gap-4">
                            <div class="w-12 h-1 bg-gradient-to-r from-oro to-oro-light rounded-full shadow-[0_0_10px_rgba(165,127,44,0.5)]"></div>
                            <span class="text-[10px] sm:text-xs font-bold uppercase tracking-[0.2em] text-oro drop-shadow-sm">Recursos Humanos</span>
                        </div>
                        <p class="hidden sm:block mt-8 text-[10px] text-gray-400 font-bold uppercase tracking-[0.2em] drop-shadow-sm">
                ...
                <div class="w-full md:w-1/2 p-8 sm:p-12 flex flex-col justify-center bg-white dark:bg-gray-900 shadow-[-10px_0_30px_rgba(0,0,0,0.1)] z-20">
